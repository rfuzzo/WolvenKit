...
{	
	...
	outColor = vec3(vPosition.z,vColor.yz);
	texCoord = vTexCoord;

	outNormal = (cameraData.view * modelMatrix * vec4(vNormal,0.f)).xyz;

	vec4 localpos = cameraData.view * modelMatrix * vec4(vPosition, 1.0f);
